...
class NgxMitaaService {
    ...
    getContinents() {
        var _a;
        return (_a = this.locations) === null || _a === void 0 ? void 0 : _a.map((continent) => continent.continent);
    }
    /**
    ...
    getCountries(continent = 'Africa') {
        var _a;
        return (((_a = this.locations
            .find((location) => location.continent.toLocaleLowerCase() ===
            continent.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.countries.map((country) => country.country)) || []);
    }
    /**
    ...
    getRegions(country = 'Tanzania', continent = 'Africa') {
        var _a, _b;
        return (((_b = (_a = this.locations
            .find((location) => location.continent.toLocaleLowerCase() ===
            continent.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.countries.find((location) => location.country.toLocaleLowerCase() === country.toLocaleLowerCase())) === null || _b === void 0 ? void 0 : _b.regions.map((region) => region.region)) || []);
    }
    /**
    ...
    getDistricts(region = 'Dar es Salaam', country = 'Tanzania', continent = 'Africa') {
        var _a, _b, _c;
        return (((_c = (_b = (_a = this.locations
            .find((location) => location.continent.toLocaleLowerCase() ===
            continent.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.countries.find((location) => location.country.toLocaleLowerCase() === country.toLocaleLowerCase())) === null || _b === void 0 ? void 0 : _b.regions.find((location) => location.region.toLocaleLowerCase() === region.toLocaleLowerCase())) === null || _c === void 0 ? void 0 : _c.districts.map((district) => district.district)) || []);
    }
    /**
    ...
    getWards(district = 'Kinondoni', region = 'Dar es Salaam', country = 'Tanzania', continent = 'Africa') {
        var _a, _b, _c, _d;
        return (((_d = (_c = (_b = (_a = this.locations
            .find((location) => location.continent.toLocaleLowerCase() ===
            continent.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.countries.find((location) => location.country.toLocaleLowerCase() === country.toLocaleLowerCase())) === null || _b === void 0 ? void 0 : _b.regions.find((location) => location.region.toLocaleLowerCase() === region.toLocaleLowerCase())) === null || _c === void 0 ? void 0 : _c.districts.find((location) => location.district.toLocaleLowerCase() ===
            district.toLocaleLowerCase())) === null || _d === void 0 ? void 0 : _d.wards.map((ward) => ward.ward)) || []);
    }
    /**
    ...
    getStreets(ward = 'Magomeni', district = 'Kinondoni', region = 'Dar es Salaam', country = 'Tanzania', continent = 'Africa') {
        var _a, _b, _c, _d, _e;
        return (((_e = (_d = (_c = (_b = (_a = this.locations
            .find((location) => location.continent.toLocaleLowerCase() ===
            continent.toLocaleLowerCase())) === null || _a === void 0 ? void 0 : _a.countries.find((location) => location.country.toLocaleLowerCase() === country.toLocaleLowerCase())) === null || _b === void 0 ? void 0 : _b.regions.find((location) => location.region.toLocaleLowerCase() === region.toLocaleLowerCase())) === null || _c === void 0 ? void 0 : _c.districts.find((location) => location.district.toLocaleLowerCase() ===
            district.toLocaleLowerCase())) === null || _d === void 0 ? void 0 : _d.wards.find((location) => location.ward.toLocaleLowerCase() === ward.toLocaleLowerCase())) === null || _e === void 0 ? void 0 : _e.streets.sort()) || []);
    }
}
